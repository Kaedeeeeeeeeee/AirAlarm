...
class LocalizationManager {
    ...
    private let translations: [Language: [String: String]] = [
        .english: [
            ...
            "tap_new_day": "Tap anywhere to start your day",
            "morning_quote_1": "Take a deep breath. Today is yours.",
            "morning_quote_2": "The morning sun is your fresh start.",
            "morning_quote_3": "Remember to drink a glass of warm water.",
            "morning_quote_4": "Stretch your body — you deserve a gentle beginning.",
            "morning_quote_5": "The world is quiet now, just for you.",
            "morning_quote_6": "Good things are waiting for you today.",
            "morning_quote_7": "You rested well. Now go shine.",
            "morning_quote_8": "Every sunrise is an invitation to a new day.",
        ],
        .chinese: [
            "wake_window": "唤醒窗口",
            ...
            "tap_new_day": "点击屏幕，开启新的一天",
            "morning_quote_1": "深呼吸，今天是属于你的一天。",
            "morning_quote_2": "晨光正好，愿你心怀期待。",
            "morning_quote_3": "记得喝杯温水，开启美好一天。",
            "morning_quote_4": "伸个懒腰吧，温柔地和世界说早安。",
            "morning_quote_5": "阳光正好，微风不燥。",
            "morning_quote_6": "美好的事情正在路上，向你走来。",
            "morning_quote_7": "睡了个好觉，今天也要加油哦。",
            "morning_quote_8": "每一个清晨，都是生活的一份礼物。",
        ],
        .japanese: [
            "wake_window": "起床ウィンドウ",
            ...
            "tap_new_day": "タップして新しい一日を始めよう",
            "morning_quote_1": "深呼吸して、今日はあなたの一日です。",
            "morning_quote_2": "朝の光は、新しいスタートの合図。",
            "morning_quote_3": "一杯の白湯で、穏やかな朝を。",
            "morning_quote_4": "背伸びして、やさしく一日を始めよう。",
            "morning_quote_5": "空が澄んでいて、風が気持ちいい。",
            "morning_quote_6": "今日もきっと、いいことがありますよ。",
            "morning_quote_7": "よく眠れましたね。今日もがんばって。",
            "morning_quote_8": "毎朝は、新しい一日への招待状。",
        ]
    ]
}
